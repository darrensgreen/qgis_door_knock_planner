...
-   **Visit Points (Ordered):** A point layer showing the addresses to be visited. Its Attribute Table contains `crew_id`, `visit_order`, and `cost` (travel time/distance) fields to guide the crews.
